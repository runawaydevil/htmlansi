...
import type { DetectionResult, DetectionHints, SourceFormat, DetectionConfidence } from './types.js';
...
export function detect(buffer: Uint8Array, filename?: string): DetectionResult {
